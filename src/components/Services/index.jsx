...
const Services = () => {
    ...
    return (
        ...
        <Container id="#services">
            ...
            <Row>
                <Column1>
                    <ServicesImage src="/static/media/ServicesNumber1.svg"></ServicesImage>
                </Column1>
                <Column2>
            ...
            <Row>
                <Column1>
                    <ServicesImage src="/static/media/ServicesNumber2.svg"></ServicesImage>
                </Column1>
                <Column2>
            ...
            <Row>
                <Column1>
                    <ServicesImage src="/static/media/ServicesNumber3.svg"></ServicesImage>
                </Column1>
                <Column2>
            ...
            <Row>
                <Column1>
                    <ServicesImage src="/static/media/ServicesNumber4.svg"></ServicesImage>
                </Column1>
                <Column2>
            ...
            <Row>
                <Column1>
                    <ServicesImage src="/static/media/ServicesNumber5.svg"></ServicesImage>
                </Column1>
                <Column2>
            ...
            <Row>
                <Column1>
                    <ServicesImage src="/static/media/ServicesNumber6.svg"></ServicesImage>
                </Column1>
                <Column2>
