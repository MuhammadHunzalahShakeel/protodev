  ...
  return (
    <section id='connect'>
        ...
        <ul className='connect_ul'>
          ...
          <li className='connect_icon' id='connect_email'><a href="mailto:clients@protodev.co" rel='noopener' target='_blank'><img className='connect_icon' src={EmailIcon} alt="" /></a></li>
        </ul>
      </div>
    </section>
  )
