  ...
  return (
    ...
    <section id='connect'>
        ...
        <ul>
          ...
          <li className='connect_icon' id='connect_email'><a href="https://www.facebook.com/profile.php?id=100088868936092" rel='noopener' target='_blank'><img className='connect_icon' src={EmailIcon} alt="" /></a></li>
        </ul>
