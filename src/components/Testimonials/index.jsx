...
const Testimonials = () => {
    ...
    return (
        ...
        <Box id="#testimonials">
            ...
            <Row>
                {isPC && <Back src="/static/media/TestimonialsSubBackground.svg"></Back>}
                {isMobile && <Back src="/static/media/TestimonialsSubBackgroundMobile.svg"></Back>}
                <Quote>
                    <QuoteImage src="/static/media/TestimonialsQuoteVector.svg"></QuoteImage>
                    <p>{content[count]}</p>
                <Forward><ForwardImage onClick={()=>increment()} src="/static/media/TestimonialsForwardButton.svg"></ForwardImage></Forward>
                <Backward><BackwardImage onClick={()=>decrement()} src="/static/media/TestimonialsBackwardButton.svg"></BackwardImage></Backward>
                </Quote>
            </Row>
        </Box>
        </>
